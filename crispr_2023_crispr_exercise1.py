...
Original file is located at
    https://colab.research.google.com/drive/1b6SN8UaSqdMnp49MXY8Z3JudGFMWAEDm

# Warming up excercise
Below you will find the first excercise, in which you will be introduced a small CRISPR on-target model in Tensorflow / Keras and use it to train a small ontarget efficiency model on real data.
...
Compare the mean squared error and mean absolute error you obtain for the best model with those obtained for the full model trained on the same data (mae 9.1, mse 141.3)?
...
Play with the model and parameters to get a better performance. Can you beat the full the model performance? What would be the proper way to **test** that?
"""
