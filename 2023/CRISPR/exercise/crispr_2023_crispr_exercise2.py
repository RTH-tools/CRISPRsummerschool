# -*- coding: utf-8 -*-
"""crispr_2023_crispr_Exercise2_20230731

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LJ0yba4R-dRXe_ppas94EpjoZ4onm4Ed

# Extracting features from the deep learning results
Below you will find the second excercise.

Before you start, please upload the training.pickle and validation.pickle files, like for exercise one. (All data stored with the notebook runtime data is lost).
...
"""## Excercise 2.1 Model definition and baseline performance (5-10 minutes)
...
print(conv1_out_30.get_weights)

print(model.get_layer('conv_3_30').get_weights())
